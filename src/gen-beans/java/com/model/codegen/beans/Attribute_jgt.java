//
// AUTOMATICALLY GENERATED from template file Attribute.jgt
// 
...
public class Attribute_jgt extends TemplateBean
{   
    /*------------------------------------------------------------------------*\
     * Fields & constants:                                                    *
    \*------------------------------------------------------------------------*/
     ...
     */    
    public Attribute_jgt(TemplateBean parent)
    {
     ...
     */
    public Attribute_jgt setDataType(java.lang.String value)
    {
     ...
     * @return the reference to the current template bean
     */
    public Attribute_jgt setAttributeName(java.lang.String value)
    {
    ...
    protected void initialize()
    {
        ...
        partList.add(new TextPart("@CsvBindByName\npublic ",0));
