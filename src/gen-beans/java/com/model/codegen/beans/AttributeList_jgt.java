//
// AUTOMATICALLY GENERATED from template file AttributeList.jgt
// 
 ...
 *  
 * Template Bean: AttributeList_jgt <br>
...
public class AttributeList_jgt extends TemplateBean
{   
    /*------------------------------------------------------------------------*\
     * Fields & constants:                                                    *
    \*------------------------------------------------------------------------*/
     ...
     */
    public static final java.lang.String ID = "AttributeList.";            
    
    /*------------------------------------------------------------------------*\
     * Constructors:                                                          *
    \*------------------------------------------------------------------------*/

    public AttributeList_jgt()
    {
        initialize();
    }
     ...
     */    
    public AttributeList_jgt(TemplateBean parent)
    {
     ...
     */
    public AttributeList_jgt setDataType(java.lang.String value)
    {
     ...
     * @return the reference to the current template bean
     */
    public AttributeList_jgt setAttributeName(java.lang.String value)
    {
    ...
    protected void initialize()
    {
        ...
        partList.add(new TextPart("@CsvBindAndSplitByName(elementType= ",0));
        partList.add(new VariablePart("DataType","<<DataType>>",36));
        partList.add(new TextPart(".class, splitOn=\"\\\\|\")\npublic ",52));
        partList.add(new TextPart("List<",0));
        partList.add(new VariablePart("DataType","<<DataType>>",12));
        partList.add(new TextPart("> ",21));
        partList.add(new VariablePart("AttributeName","<<AttributeName>>",30));
