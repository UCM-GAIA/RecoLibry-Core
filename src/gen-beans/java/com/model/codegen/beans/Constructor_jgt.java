 ...
 * Generation Timestamp: Mon Feb 04 11:33:57 CET 2019 <br>
...
{   
    ...
    public static class foreachAttributeList
    {
         ...
         * @param parent parent bean for value propagation
         */
        protected foreachAttributeList(Constructor_jgt parent)
        {
            this.parent = parent;
            if (this.parent != null)
            {
         ...
         * @return reference to current template bean.
         */
        public Constructor_jgt prepend(ArgumentList_jgt bean)
        {
         ...
         * @return reference to current template bean
         */
        public Constructor_jgt append(ArgumentList_jgt bean)
        {
         ...
         * @return reference to current template bean 
         */
        public Constructor_jgt set(ArgumentList_jgt bean)
        {
         ...
         * @return reference to current template bean.
         */
        public Constructor_jgt prepend(AttributeListInit_jgt bean)
        {
            parent.subTemplateStructureMap.prepend("foreachAttributeList", bean);    
            return parent;
        }
         ...
         * @return reference to current template bean
         */
        public Constructor_jgt append(AttributeListInit_jgt bean)
        {
            parent.subTemplateStructureMap.append("foreachAttributeList", bean);    
            return parent;
        }
         ...
         * @return reference to current template bean 
         */
        public Constructor_jgt set(AttributeListInit_jgt bean)
        {
            parent.subTemplateStructureMap.put("foreachAttributeList", bean);
            return parent;
        }
    ...
    protected void initialize()
    {
        ...
        partList.add(new SubTemplateStructurePart("foreachAttributeList",66,"ArgumentList."));
        partList.add(new TextOperatorPart(new DeleteTrailingWhitespaceLinesOperator(",")));
        partList.add(new TextPart(")  \n{\n    ",189));
        ...
        partList.add(new TextPart("\n    ",48));
        partList.add(new SubTemplateStructurePart("foreachAttributeList",4,"AttributeListInit."));
        partList.add(new TextOperatorPart(new DeleteTrailingWhitespaceLinesOperator(null)));
        partList.add(new TextPart("\n}\n",56));
    }
}
